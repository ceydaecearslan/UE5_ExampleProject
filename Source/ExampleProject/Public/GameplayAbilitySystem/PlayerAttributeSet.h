 ...
 */
UCLASS()
class EXAMPLEPROJECT_API UPlayerAttributeSet : public UAttributeSet
{
	GENERATED_BODY()
...
public:
	...
	UPROPERTY(BlueprintReadOnly, Category = "Attributes | Stamina", ReplicatedUsing = OnRep_HealthRegenRate)
